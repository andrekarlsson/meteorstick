    ...
    OAuth.prototype = {
        ...
        init: function (options) {
            ...
            this.request = function (options) {
                ...
                //urlString = 'http://api.telldus.com/json/sensors/list';
                ...
                //     } else {
                for(i in params) {
                    query.push(OAuth.urlEncode(i) + '=' + OAuth.urlEncode(params[i] + ''));
                }
                ...
                var result = Meteor.http.call(method, urlString+ '?' + query , {
                ...
                if(result.statusCode === 200){
                    ...
                    failure(urlString+ '?' + query);
                }
                //console.log(toHeaderString(headerParams));
                //console.log(result);
            };
